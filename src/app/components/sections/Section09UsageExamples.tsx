      ...
      <div className="space-y-6">
        ...
        <Card label="2. Website Hero Section">
          <div style={{ background: "linear-gradient(135deg, #0B4F2A 0%, #1F6B3A 60%, #4F9A3D 100%)", borderRadius: 12, padding: "48px 40px", position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 12, color: "rgba(255,255,255,0.55)", textAlign: "center", marginTop: 8 }}>
        ...
        <Card label="3. Bank-Ready Report Cover">
          <div style={{ background: "#FAF7EF", border: "1px solid #d4e8db", borderRadius: 8, padding: "32px", maxWidth: 480 }}>
            ...
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 10, color: "#4F9A3D", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 8 }}>Official Report</p>
            <p style={{ fontFamily: "'Playfair Display', serif", fontSize: 22, fontWeight: 700, color: "#1E2420", marginBottom: 4, lineHeight: 1.2 }}>Annual Farm Operations</p>
            <p style={{ fontFamily: "'Playfair Display', serif", fontSize: 22, fontWeight: 700, color: "#1F6B3A", marginBottom: 16, lineHeight: 1.2 }}>& Circular Energy Report</p>
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 12, color: "#666", marginBottom: 4 }}>Fiscal Year 2024–2025</p>
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 12, color: "#888" }}>Prepared for: Agricultural Credit Division, Bangladesh Bank</p>
            <div style={{ borderTop: "1px solid #e0eed5", marginTop: 20, paddingTop: 12 }}>
              <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 11, color: "#999" }}>Kutirchar EcoFarm · Kutirchar, Bhadraghat, Kamarkhanda, Sirajganj, Bangladesh</p>
            </div>
          </div>
        </Card>
          ...
          <div className="flex gap-4 flex-wrap">
            <div style={{ width: 280, background: "#FAF7EF", border: "1px solid #d4e8db", borderRadius: 8, padding: "20px 18px" }}>
              ...
              <div style={{ borderTop: "1px solid #e0eed5", marginTop: 14, paddingTop: 12 }}>
                ...
                <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 11, color: "#4F9A3D", fontWeight: 500, marginTop: 2 }}>Farm Director & Operations Head</p>
                <div className="mt-3 space-y-1">
                  <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 10, color: "#666" }}>📞 +880 1700-000000</p>
            ...
            <div style={{ width: 280, background: "#0B4F2A", borderRadius: 8, padding: "20px 18px" }}>
              ...
              <div style={{ borderTop: "1px solid rgba(255,255,255,0.2)", marginTop: 14, paddingTop: 12 }}>
                ...
                <div className="mt-3 space-y-1">
                  <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 10, color: "rgba(255,255,255,0.6)" }}>📞 +880 1700-000000</p>
        ...
        <Card label="5. Social Media Profile">
          <div className="flex gap-6 flex-wrap items-start">
            <div className="flex flex-col items-center gap-2">
              ...
              <span style={{ fontFamily: "'Inter', sans-serif", fontSize: 11, color: "#888" }}>WhatsApp / Facebook</span>
            </div>
            <div className="flex flex-col items-center gap-2">
              ...
              <span style={{ fontFamily: "'Inter', sans-serif", fontSize: 11, color: "#888" }}>LinkedIn / App Icon</span>
            </div>
          ...
          <div style={{ background: "white", border: "1px solid #ddd", borderRadius: 8, padding: "24px 28px" }}>
            <div className="flex items-start justify-between mb-4">
              ...
              <div style={{ textAlign: "right" }}>
                ...
                <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 10, color: "#4F9A3D", marginTop: 4 }}>www.kutircharecofarm.com</p>
              </div>
            </div>
            <div style={{ borderBottom: "2px solid #1F6B3A", marginBottom: 16 }} />
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 11, color: "#888" }}>Date: June 23, 2026</p>
